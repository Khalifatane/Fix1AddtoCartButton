  ...
  return `
    <div class="group relative"
      ...
      <div class="z3wmw">
        ...
        <button class="dvh79 cti9j w-full inline-flex lp3ls items-center my9gz yymkp at2zb edpyz pm6ks mak94 ve4ck bni17 pucrg disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden soa63 mt-2"
          type="button"
          data-product-id="${escapeHtml(productId)}"
          data-product-title="${escapeHtml(productTitle)}"
          data-product-href="${escapeHtml(productHref)}"
